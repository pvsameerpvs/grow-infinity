...
export default function ComplianceSolutions() {
  const benefits = [
    {
      icon: Shield,
      title: "Full Regulatory Shield",
      description:
        "Stay compliant with FTA, Ministry of Economy, and all UAE federal regulatory bodies.",
    },
    {
      icon: FileCheck,
      title: "Expert PRO Liaisons",
      description:
        "Priority government liaison for visas, labor card approvals, and all official government filings.",
    },
    {
      icon: Calculator,
      title: "VAT & Tax Strategy",
      description:
        "Advanced VAT registration, precise filing, and strategic corporate tax optimization.",
    },
    {
      icon: BookOpen,
      title: "Elite Bookkeeping",
      description:
        "Cloud-based accounting with audit-ready reporting using Xero and QuickBooks ecosystems.",
    },
    {
      icon: Scale,
      title: "Legal Integrity",
      description:
        "Ensure your business operations meet high-standard UAE commercial and labor laws.",
    },
    {
      icon: Zap,
      title: "Real-time Updates",
      description:
        "Proactive monitoring of UAE regulatory changes to keep your enterprise penalty-free.",
    },
  ];
  ...
  const services = [
    {
      name: "PRO SERVICES",
      description:
        "Complete government liaison for all visas, permits, and labor-legal approvals.",
      icon: FileText,
      link: "/pro-services-uae",
    },
    {
      name: "VAT COMPLIANCE",
      description:
        "FTA registration, quarterly reporting, and strategic tax refund management.",
      icon: Calculator,
      link: "/vat-registration-uae",
    },
    {
      name: "CORPORATE TAX",
      description:
        "Optimization for the 9% tax regime with professional advisory and filing support.",
      icon: TrendingUp,
      link: "/corporate-tax-uae",
    },
  ];
    ...
    <div className="min-h-screen bg-background selection:bg-primary/20 transition-colors duration-500">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h4 className="text-gold font-black tracking-[0.4em] uppercase text-xs text-gradient-infinity">
                  Operational Integrity
                </h4>
              </div>
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                Regulatory{" "}
                <span className="text-gradient-infinity block italic font-normal tracking-tight">
                  Compliance
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Eliminate administrative friction. Our compliance experts handle
                everything from VAT filing to PRO services, ensuring your
                enterprise operates with total legal integrity.
              </p>
      ...
      <section className="py-32 relative z-10 bg-background">
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-6 tracking-tight">
              Compliance{" "}
              <span className="text-gradient-infinity italic font-normal">
                Shield
              </span>
            </h2>
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium leading-relaxed">
              Complete administrative peace of mind so you can focus on scaling
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-black text-foreground mb-4 uppercase tracking-tighter leading-none">
                  {service.name}
                </h3>
                <p className="text-foreground/60 mb-10 leading-relaxed font-medium flex-grow">
                  {service.description}
                </p>
                <Link
                  href={service.link}
                  className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-xs hover:gap-6 transition-all duration-300"
                >
      ...
      <section className="py-40 bg-foreground text-white relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            <h2 className=" text-7xl md:text-9xl font-black mb-12 uppercase leading-none tracking-tighter">
            ...
            <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto leading-relaxed font-medium">
              Join the growing list of penalty-free enterprises. Secure your
              full-spectrum compliance audit today.
            </p>
