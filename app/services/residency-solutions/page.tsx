  ...
  const benefits = [
    {
      ...
      description:
        "Secure your future in the UAE with 10-year Golden Visas for you and your family.",
    },
    {
      icon: Shield,
      title: "Total Independence",
      description:
        "Golden Visa holders enjoy complete independence without the need for a local sponsor.",
    },
    {
      icon: Users,
      title: "Family Legacy",
      description:
        "Sponsor your spouse, children, and parents to live with you in the world's safest city.",
    },
    {
      icon: Briefcase,
      title: "Business Freedom",
      description:
        "Own 100% of your enterprise and work freely across all seven Emirates.",
    },
    {
      icon: Heart,
      title: "Elite Lifestyle",
      description:
        "Access top-tier healthcare, global education, and a tax-free, high-luxury environment.",
    },
    {
      icon: Award,
      title: "Estate Protection",
      description:
        "Protect your legacy with UAE-specific wills and comprehensive wealth planning.",
    },
  ];
  ...
  const visaTypes = [
    {
      ...
      description:
        "For investors, tech-founders, doctors, and exceptional global talents.",
      requirements: [
        "AED 2M+ Investment",
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h4 className="text-gold font-black tracking-[0.4em] uppercase text-xs text-gradient-gold">
                  UAE Residency Excellence
                </h4>
              </div>
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                Your Future <br />
                <span className="text-gradient-infinity block italic font-normal tracking-tight underline-offset-8">
                  in the UAE
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Join the world's most dynamic elite community. We handle every
                detail of your Golden Visa journey, from eligibility assessment
                to Emirates ID issuance for your entire family.
              </p>
            ...
            >
              <div className="relative rounded-[4rem] overflow-hidden aspect-[4/5] border border-foreground/10 shadow-3xl group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-12">
                  <div>
                    <h3 className="text-4xl font-black text-white uppercase leading-none mb-4">
                      A Modern <br />
                      Legacy
                    </h3>
                    <p className="text-white/60 font-medium">
                      Join 100,000+ Golden Visa holders in the world's safest
                      sanctuary.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground">
                    Premium Status
                  </div>
                </div>
              </motion.div>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium">
              Why the world's most successful entrepreneurs choose the UAE as
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {visaTypes.map((visa, index) => (
              ...
              >
                ...
                <h3 className="text-4xl font-black text-foreground uppercase mb-6 tracking-tighter leading-none">
                  {visa.name}
                </h3>
                <p className="text-lg text-foreground/50 mb-10 leading-relaxed font-medium">
                  {visa.description}
                </p>
                <div className="space-y-4">
                  <p className="text-xs font-black text-foreground/30 uppercase tracking-[0.3em] mb-4">
                    Core Criteria
                  </p>
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto leading-relaxed">
              Start your journey today. Get a private eligibility assessment for
              UAE residency within 24 hours.
            </p>
