  ...
  const benefits = [
    {
      ...
      description:
        "Complete confidentiality with no public disclosure of shareholders or beneficial owners.",
    },
    {
      icon: Shield,
      title: "Asset Protection",
      description:
        "Safeguard your wealth with robust legal structures and international asset protection.",
    },
    {
      icon: Globe2,
      title: "Global Business",
      description:
        "Conduct international business operations without geographical restrictions.",
    },
    {
      icon: Zap,
      title: "Tax Neutrality",
      description:
        "Zero corporate tax, income tax, and capital gains tax for offshore entities.",
    },
    {
      icon: Eye,
      title: "Confidentiality",
      description:
        "Simplified compliance with no mandatory audit or annual public filing requirements.",
    },
    {
      icon: TrendingUp,
  ...
  const jurisdictions = [
    {
      ...
      description:
        "UAE's premier offshore jurisdiction offering complete privacy and tax neutrality.",
    ...
    },
    {
      ...
      description:
        "Established offshore jurisdiction with strong reputation and direct banking access.",
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                Offshore{" "}
                <span className="text-gradient-gold block italic">
                  Security
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Establish high-privacy corporate structures in the UAE. Robust
                asset protection, zero tax, and complete confidentiality for
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-6">
              Elite{" "}
              <span className="text-gradient-infinity italic">Advantages</span>
            </h2>
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium leading-relaxed">
              Designed for global asset protection, international trading, and
              seamless wealth holding.
            </p>
          </div>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase tracking-tight">
              Premier{" "}
              <span className="text-gradient-infinity">Jurisdictions</span>
            </h2>
          </div>
            ...
            {jurisdictions.map((fz, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-10">
                  <div>
                    <h3 className="text-4xl font-black text-foreground tracking-tighter uppercase leading-none mb-4">
                      {fz.name}
                    </h3>
                ...
                <div className="pt-8 border-t border-foreground/10 flex justify-between items-center">
                  <div className="text-xs font-black text-foreground/30 uppercase tracking-[0.3em]">
                    Entry Cost
                  </div>
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto font-medium">
              Start your confidential offshore journey today. UAE's most robust
              asset protection starts here.
            </p>
