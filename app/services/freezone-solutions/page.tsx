  ...
  const benefits = [
    {
      ...
      description:
        "Zero corporate and personal income tax for renewable periods of up to 50 years.",
    },
    {
      icon: Globe2,
      title: "100% Ownership",
      description:
        "Full ownership of your enterprise without any requirement for a UAE national agent.",
    },
    {
      icon: Shield,
      title: "Full Repatriation",
      description:
        "Transfer 100% of capital and profits back to your home jurisdiction without friction.",
    },
    {
      icon: Zap,
      title: "Rapid Deployment",
      description:
        "Business setup in as little as 48 hours with our specialized digital onboarding.",
    },
    {
      icon: Users,
      title: "Global Visas",
      description:
        "Residency visas for your entire team and family based on selected infrastructure.",
    },
    {
      icon: Building,
      title: "Elite Ecosystem",
      description:
        "Access to world-class office spaces, industrial hubs, and specialized logistics.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h4 className="text-primary font-black tracking-[0.4em] uppercase text-xs text-gradient-infinity">
                  The Global Hub
                </h4>
              </div>
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                Free Zone{" "}
                <span className="text-gradient-infinity block italic">
                  Solutions
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Accelerate your international growth in UAE's world-renowned
                Free Zones. 100% ownership, 0% tax, and absolute operational
                freedom.
              </p>
              ...
              <div className="relative rounded-[4rem] overflow-hidden aspect-video border border-foreground/10 shadow-3xl group">
                ...
                <div className="absolute bottom-10 left-10 p-6 glass rounded-2xl border border-white/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-white font-black text-xs uppercase tracking-widest leading-none">
                      Instant Activation
                    </div>
                  </div>
                </div>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium leading-relaxed">
              Experience a tax-neutral environment built for international trade
      ...
      <section className="py-32 relative z-10 bg-foreground/[0.01]">
        <div className="container px-4 mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-24 gap-8 text-center lg:text-left">
            <div>
              <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-4 tracking-tight leading-none">
                Popular <span className="text-gradient-infinity">Zones</span>
              </h2>
              <p className="text-xl text-foreground/50 font-medium">
                Global hubs tailored for your specific industry.
              </p>
            </div>
          </div>
              ...
              >
                <div className="relative rounded-[3rem] overflow-hidden aspect-[4/3] mb-8 border border-foreground/10 shadow-3xl cursor-pointer">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-8 glass-dark border-t border-white/10 translate-y-[101%] group-hover:translate-y-0 transition-transform duration-500">
                    <p className="text-white/80 text-sm font-black uppercase tracking-[0.2em] mb-2">
                      Specialization
                    </p>
                ...
                <div className="px-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-primary font-black text-sm tracking-widest">
                      {fz.minCost}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {fz.features.map((feat) => (
                      <div key={feat} className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold text-foreground/70 uppercase tracking-tight">
                          {feat}
                        </span>
                      </div>
                    ))}
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto leading-relaxed">
              Your gateway to zero tax and absolute ownership. Secure your Free
              Zone setup in 48 hours.
            </p>
