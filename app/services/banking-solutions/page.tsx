  ...
  const benefits = [
    {
      ...
      description:
        "Open accounts in AED, USD, EUR, GBP and 20+ other currencies for global transactions.",
    },
    {
      icon: Shield,
      title: "Secure Banking",
      description:
        "UAE banks offer world-class security with advanced fraud protection and encryption.",
    },
    {
      icon: Globe2,
      title: "International Transfers",
      description:
        "Swift and seamless international wire transfers with competitive exchange rates.",
    },
    {
      icon: CreditCard,
      title: "Corporate Cards",
      description:
        "Get corporate debit and credit cards for business expenses and team members.",
    },
    {
      icon: Zap,
      title: "Online Banking",
      description:
        "Advanced digital banking platforms with 24/7 access to your accounts.",
    },
    {
      icon: TrendingUp,
      title: "Business Loans",
      description:
        "Access to business financing, trade finance, and credit facilities.",
    },
  ];
  ...
  const banks = [
    {
      name: "Emirates NBD",
      type: "Local Giant",
      features: ["Best for Mainland", "Digital Leader", "Premier Support"],
      minDeposit: "AED 25k",
    ...
    },
    {
      name: "Mashreq Bank",
      type: "SME Leader",
      features: ["Trade Intensive", "Quick Approvals", "Vibrant Tech"],
      minDeposit: "AED 20k",
      image: "/services/banking_category.jpg",
    },
    {
      name: "ADCB",
      type: "Premium Choice",
      features: ["Corporate Focus", "Multi-Currency", "Global Reach"],
      minDeposit: "AED 50k",
      image: "/services/banking_category.jpg",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex items-center space-x-3 mb-8">
                ...
                <h4 className="text-primary font-black tracking-[0.4em] uppercase text-xs ">
                  Elite Financial Partnerships
                </h4>
              </div>
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                Corporate{" "}
                <span className="text-gradient-infinity block italic font-normal">
                  Banking
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Unlock instant access to the region's elite banking network. We
                fast-track your multi-currency corporate account setups with
                guaranteed pre-approval support.
              </p>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-6 tracking-tight">
              Banking{" "}
              <span className="text-gradient-infinity italic">Privileges</span>
            </h2>
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium">
              World-class financial infrastructure standardized for global
              commerce.
            </p>
          </div>
              ...
              >
                <div className="relative rounded-[3rem] overflow-hidden aspect-[16/10] mb-8 border border-foreground/10 shadow-3xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8">
                    <div>
                      <div className="text-gold font-black text-[10px] uppercase tracking-widest mb-2">
                        {bank.type}
                      </div>
                ...
                <div className="px-6 space-y-6">
                  <div className="flex flex-wrap gap-2">
                    {bank.features.map((f) => (
                      <span
                        key={f}
                        className="px-3 py-1 bg-primary/10 rounded-lg text-[10px] font-bold text-primary uppercase tracking-widest"
                      >
                        {f}
                      </span>
                    ))}
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto leading-relaxed">
              Skip the rejection cycles. Get your corporate bank account
              pre-approved by the region's top financial institutions.
            </p>
            <Link href="/contact">
