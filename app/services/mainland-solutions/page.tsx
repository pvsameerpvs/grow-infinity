  ...
  const benefits = [
    {
      ...
      description:
        "Own your business completely without the need for a local sponsor in most activities.",
    },
    {
      icon: Building2,
      title: "Unlimited Scope",
      description:
        "Conduct business anywhere in the UAE and internationally with no restrictions.",
    },
    {
      icon: TrendingUp,
      title: "Government Projects",
      description:
        "Eligible to bid for and secure lucrative government tenders and contracts.",
    },
    {
      icon: Shield,
      title: "Legal Protection",
      description:
        "Complete protection under UAE laws with full access to local courts.",
    },
    {
      icon: Users,
      title: "Unlimited Visas",
      description:
        "Sponsor unlimited employees and family members with streamlined processing.",
    },
    {
      icon: Zap,
      title: "Market Dominance",
      description:
        "Immediate access to the thriving domestic market of 10M+ residents.",
    },
  ];
    ...
    <div className="min-h-screen bg-background selection:bg-primary/20 transition-colors duration-500">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-12 leading-[0.95] tracking-tighter uppercase">
                UAE{" "}
                <span className="text-gradient-infinity block">Mainland</span>{" "}
                Expansion
              </h1>
              <p className="text-xl md:text-2xl text-foreground/60 leading-relaxed max-w-2xl font-medium mb-12">
                Dominate the local market with a Mainland license. Complete
                freedom to trade, scale, and secure government contracts across
                all seven Emirates.
              </p>
        ...
        <div className="container px-4 mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium">
              Why the world's leading enterprises choose the UAE Mainland
              structure.
            </p>
          </div>
      ...
      <section className="py-32 relative z-10 bg-foreground/[0.01]">
        <div className="container px-4 mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-12">
                ...
                {process.map((step, index) => (
                  ...
                  >
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 rounded-2xl border-2 border-primary/20 flex items-center justify-center text-2xl font-black text-primary group-hover:bg-primary group-hover:text-white transition-all">
                        {step.step}
                      </div>
                    </div>
                    <div>
                      <h3 className="text-xl font-black text-foreground uppercase mb-2 tracking-tight flex items-center gap-3">
                        {step.title}
                        <span className="text-[10px] bg-primary/10 text-primary px-2 py-1 rounded-lg tracking-widest">
                          {step.duration}
                        </span>
                      </h3>
      ...
      <section className="py-32 relative z-10 bg-background">
        <div className="container px-4 mx-auto text-center">
          <h2 className=" text-4xl md:text-6xl font-black text-foreground uppercase mb-24">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            {licenseTypes.map((type, index) => (
              ...
              >
                ...
                <h3 className="text-3xl font-black text-foreground uppercase mb-4 tracking-tighter">
                  {type.type}
                </h3>
                ...
                <div className="space-y-3 w-full">
                  {type.activities.map((act) => (
                    <div
                      key={act}
                      className="px-6 py-3 bg-foreground/5 rounded-2xl text-sm font-black text-foreground/70 border border-foreground/5 uppercase tracking-widest"
                    >
                      {act}
                    </div>
                  ))}
      ...
      <section className="py-40 bg-foreground text-white relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          ...
          >
            <h2 className=" text-6xl md:text-8xl font-black mb-12 uppercase leading-none tracking-tighter">
              Start Your <br />
