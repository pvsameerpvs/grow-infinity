    ...
    <div className="min-h-screen bg-background selection:bg-primary/20 pt-32 pb-40">
      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          >
            ...
            <h1 className=" text-6xl md:text-8xl font-black text-foreground mb-8 tracking-tighter uppercase leading-none">
            ...
            <p className="text-xl text-foreground/50 max-w-2xl mx-auto font-medium leading-relaxed">
              Explore our comprehensive range of specialized business services,
              curated for the modern global entrepreneur in the UAE.
            </p>
          </motion.div>
        </div>
        ...
        {filteredServices.length === 0 && (
          ...
          >
            ...
            <p className="text-foreground/40 font-medium max-w-sm mx-auto">
              We couldn't find any services matching your criteria. Please try a
      ...
      <section className="mt-40 py-40 bg-foreground text-white relative overflow-hidden rounded-[4rem]">
        ...
        <div className="container px-4 mx-auto relative z-10 text-center">
          <h2 className=" text-5xl md:text-7xl font-black mb-12 uppercase leading-none tracking-tighter">
            Can't Find Your <br />
          ...
          <p className="text-2xl text-white/50 mb-16 max-w-2xl mx-auto font-medium">
            We specialize in bespoke setups. Contact our advisors for a
            customized solution tailored to your specific goals.
          </p>
          <Link href="/contact">
