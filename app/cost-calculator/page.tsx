                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          ...
                          <button
                            key={act}
                            onClick={() =>
                              handleInputChange("businessActivity", act)
                            }
                            className={cn(
                        ...
                        {[
                          {
                            id: "mainland",
                            title: "Mainland",
                            desc: "Trade anywhere in UAE",
                          },
                          {
                            id: "freezone",
                            title: "Free Zone",
                            desc: "100% Tax Free Environment",
                          },
                          {
                            id: "offshore",
                            title: "Offshore",
                            desc: "Asset Protection & Privacy",
                          },
                        ].map((j) => (
                          <button
                            key={j.id}
                            onClick={() =>
                              handleInputChange("jurisdiction", j.id)
                            }
                            className={cn(
                          ...
                          >
                            <div className="font-black text-xl mb-2 tracking-tighter uppercase italic">
                              {j.title}
                            </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        {["1", "2", "3", "4", "5+"].map((num) => (
                          <button
                            key={num}
                            onClick={() =>
                              handleInputChange("shareholders", num)
                            }
                            className={cn(
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-foreground/50 font-medium text-sm">
                      Our elite advisory team will contact you within 24 hours
                  ...
                  <div className="bg-foreground/[0.02] rounded-2xl p-6 mb-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <div className="text-[10px] font-black text-foreground/40 uppercase tracking-wider">
                          Business Activity
                        </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm font-bold text-foreground">
                          {formData.shareholders} Person(s)
                        </div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[10px] font-black text-foreground/40 uppercase tracking-wider">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm font-bold text-foreground">
                          {formData.officeType || "Not specified"}
                        </div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[10px] font-black text-foreground/40 uppercase tracking-wider">
