  ...
  const benefits = [
    {
      ...
      description:
        "Our high-net-worth clients from around the globe are constantly seeking premium office spaces to establish their UAE presence.",
    },
    {
      icon: Coins,
      title: "Premium Rental Yields",
      description:
        "Access a stream of corporate tenants prepared to pay premium rates for compliant, high-spec business environments.",
    },
    {
      icon: Handshake,
      title: "Zero-Hassle Management",
      description:
        "We handle the client vetting and documentation, ensuring only legitimate, verified businesses occupy your properties.",
    },
    {
      icon: Key,
      title: "Strategic Partnership",
      description:
        "Join our exclusive network of property partners and gain first-mover advantage on corporate relocation projects.",
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className=" text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-8 uppercase leading-[1.1]">
              List Your Property with{" "}
              <span className="text-gradient-infinity">Grow Infinity</span>
            </h2>

            <p className="text-lg text-foreground/60 mb-12 leading-relaxed font-medium">
              We connect world-class office spaces with international
              visionaries. If you own premium commercial property in the UAE,
              partner with us to secure high-tier corporate tenants and maximize
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="text-white/80 text-xs font-medium italic">
                    Join 500+ Luxury Property Partners
                  </div>
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full border-2 border-white bg-foreground/20 overflow-hidden"
                      >
                        <img
