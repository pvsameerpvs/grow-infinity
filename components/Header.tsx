...
const Header = () => {
 ...
 activeMenu === group.name ? "text-white" : "text-white/80 hover:text-white"
 )}
 >
 <span className={cn(activeMenu === group.name ? "text-white" : "")}>{group.name}</span>
 ...
 activeSubMenu === item.title ? "bg-white/10 text-white" : "text-white/60 hover:bg-white/10 hover:text-white"
 )}
 >
 ...
 <span className="text-sm font-bold uppercase tracking-widest text-white/40">Navigation</span>
 <button
 ...
 mobileExpandedGroup === group.name ? "text-white" : "text-white/70"
 )}>
 {group.name}
 </span>
 {group.items && (
 ...
 onClick={() => setIsOpen(false)}
 >
 <span className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1">Tools</span>
 ...
 onClick={() => setIsOpen(false)}
 >
 <span className="text-[10px] font-bold text-white/80 uppercase tracking-widest mb-1">Fast Track</span>
 ...
 <div>
 <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest leading-none">WhatsApp Support</p>
 <p className="text-sm font-bold text-white">+971 50 866 3700</p>
 </div>
 </div>
 </div>
 </div>
