      ...
      <div className="relative w-full rounded-[2.5rem] lg:rounded-[4rem] overflow-hidden group shadow-2xl bg-background border border-foreground/5 py-24 lg:py-48">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, #c19b4b 1px, transparent 1px)",
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="font-black uppercase tracking-[0.1em] text-sm">
                          Calculate Costs
                        </span>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      {[
                        ...
                        >
                          <div
                            className={cn(
                              "inline-flex p-4 rounded-2xl mb-6 transition-transform group-hover:scale-110 duration-500",
                              stat.bg,
                            )}
                          >
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex -space-x-3">
                          {[1, 2, 3, 4].map((i) => (
                            <div
                              key={i}
                              className="w-10 h-10 rounded-full border-2 border-background ring-4 ring-primary/5 bg-muted overflow-hidden relative group/avatar"
                            >
                              <img
                        ...
                        <div>
                          ...
                          <p className="text-[10px] uppercase font-black tracking-[0.1em] text-muted-foreground">
