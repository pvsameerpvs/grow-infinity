  ...
  if (isSuccess) {
    return (
      <motion.div
        ...
        className="glass-light dark:glass-dark p-8 rounded-[2rem] border border-[#C49A45]/20 text-center space-y-6 shadow-2xl relative overflow-hidden backdrop-blur-2xl"
      >
        <div className="w-16 h-16 rounded-full bg-[#C49A45]/10 flex items-center justify-center mx-auto mb-2 border border-[#C49A45]/20">
          <CheckCircle2 className="w-8 h-8 text-[#C49A45]" />
        </div>
        ...
        <button
          ...
          className="text-[#C49A45] font-bold text-[10px] uppercase tracking-widest hover:underline"
        >
          New Request
        </button>
      </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1 flex items-center gap-2">
              <User className="w-3 h-3 text-[#C49A45]" />
              Full Name
            </label>
            <input
              required
              ...
              className="w-full bg-black/5 dark:bg-white/5 border border-gray-200 dark:border-white/10 px-4 py-3 rounded-xl text-sm font-medium text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#C49A45]/20 focus:border-[#C49A45]/30 transition-all"
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1 flex items-center gap-2">
          ...
          <div className="space-y-1.5 relative">
            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1 flex items-center gap-2">
              <Briefcase className="w-3 h-3 text-[#C49A45]" />
              Strategy
            </label>
          ...
          <button
            ...
            className={cn(
              "w-full py-4 mt-2 rounded-xl bg-[#C49A45] text-white font-black text-[12px] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-3 shadow-xl shadow-[#C49A45]/20 active:scale-[0.98] hover:bg-[#D4B26B]",
