      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-foreground/60 max-w-3xl mx-auto leading-relaxed">
            In the UAE, a business license is only as good as the bank account
            attached to it. Our unique "Banking-First" methodology begins with
            your banking eligibility.
          </p>
        </motion.div>
          ...
          <div>
            ...
            >
              ...
              <p className="text-foreground/70 leading-relaxed">
                We pre-vet your business activity with our network of banking
                partners before we even file for your name reservation. This
                saves you weeks of frustration and ensures operational cash flow
                from day one.
              </p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {advantages.map((advantage, index) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${advantage.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500`}
                  >
