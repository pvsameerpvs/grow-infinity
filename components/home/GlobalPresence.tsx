      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base text-foreground/70 max-w-3xl mx-auto leading-relaxed">
            ...
            . Strategically positioned at the crossroads of East and West, we
            provide seamless business setup solutions and localized expertise
                ...
                {hoveredIndex === index && (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <div
                        className={`w-10 h-10 rounded-xl bg-gradient-to-br ${location.color} flex items-center justify-center`}
                      >
