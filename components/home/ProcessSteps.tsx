      ...
      <div className="relative w-full rounded-[2.5rem] lg:rounded-[4rem] overflow-hidden group shadow-2xl bg-[#fafafa] dark:bg-[#080808] border border-foreground/5">
        ...
        <div className="absolute inset-0 opacity-5">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 1px 1px, rgb(var(--foreground-rgb)) 1px, transparent 0)",
          ...
          <div className="max-w-6xl mx-auto">
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    ...
                    >
                      <AnimatePresence mode="wait">
                        {activeStep > index ? (
                          ...
                          >
                            <step.icon
                              className={`w-5 h-5 md:w-8 md:h-8 ${activeStep === index ? "text-white" : "text-foreground/40"}`}
                            />
                          </motion.div>
                        )}
                      </AnimatePresence>
                    ...
                    <div className="text-center">
                      <div
                        className={`text-[9px] md:text-xs font-black mb-0.5 md:mb-1 ${
                          activeStep === index
                            ? "text-primary"
                            : "text-foreground/40"
                        }`}
                      ...
                      <div
                        className={`text-[10px] md:text-sm font-black leading-tight ${
                          activeStep === index
                            ? "text-foreground"
                            : "text-foreground/60"
                        }`}
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="glass p-6 md:p-8 lg:p-12 rounded-2xl lg:rounded-3xl border border-foreground/5 shadow-xl"
              >
