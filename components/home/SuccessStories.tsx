...
const testimonials = [
  {
    ...
    quote:
      "Grow Infinity didn't just set up my company; they fixed my banking trajectory. Their Banking-First approach is the only way to launch in the UAE.",
    rating: 5,
    verified: true,
    setupTime: "36 hours",
    location: "Dubai, UAE",
  },
  {
    ...
    quote:
      "The speed and precision were unmatched. I had my mainland license and IBAN ready while other agencies were still doing paperwork.",
    rating: 5,
    verified: true,
    setupTime: "48 hours",
  ...
  },
  {
    ...
    quote:
      "Professional, efficient, and incredibly knowledgeable. They handled everything from licensing to banking with absolute precision.",
    rating: 5,
    verified: true,
    setupTime: "42 hours",
    location: "Singapore",
  },
  {
    ...
    quote:
      "Grow Infinity transformed my vision into reality. Their banking-first approach and deep understanding of UAE regulations made the entire process seamless and stress-free.",
    rating: 5,
    verified: true,
    setupTime: "38 hours",
    location: "Dubai, UAE",
  },
  {
    ...
    quote:
      "The level of expertise and personalized attention we received was exceptional. From free zone selection to corporate banking, every detail was handled with precision.",
    rating: 5,
    verified: true,
    setupTime: "45 hours",
    location: "London, UK",
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 gap-12">
          ...
          >
            ...
            <h2 className=" text-5xl md:text-6xl lg:text-7xl font-black mb-10 leading-[0.9] tracking-tighter uppercase text-foreground">
              Legacy <br />
              <span className="text-gradient-gold italic">Success</span>{" "}
              Stories.
            </h2>
            <p className="text-xl text-foreground/70 dark:text-white/60 font-medium max-w-lg leading-relaxed">
              We empower the world's most ambitious entrepreneurs to secure
              their place in the UAE's economic future. From Fortune 500
              companies to innovative startups, our clients trust us to
              architect their success story.
            </p>
          </motion.div>
                ...
                <div className="relative flex flex-col lg:flex-row gap-10 h-full">
                  ...
                  <div className="flex-shrink-0">
                    ...
                    >
                      <div className="glass px-4 py-3 rounded-xl border border-foreground/10 dark:border-white/10">
                        <div className="text-xs text-foreground/60 dark:text-white/50 uppercase tracking-wider font-bold mb-1">
                          Setup Time
                        </div>
                        <div className="text-lg font-black text-gold">
                          {currentTestimonial.setupTime}
                        </div>
                      </div>
                      <div className="glass px-4 py-3 rounded-xl border border-foreground/10 dark:border-white/10">
                        <div className="text-xs text-foreground/60 dark:text-white/50 uppercase tracking-wider font-bold mb-1">
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    ...
                    <motion.div
                      ...
                      className="space-y-2"
                    >
                      <h4 className="text-2xl font-black tracking-tight text-foreground dark:text-white">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-foreground/60 dark:text-white/50 text-sm font-bold">
